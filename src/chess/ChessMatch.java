...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (testCheck(currentPlayer)) {
			...
			throw new ChessException("Voce nao pode ser colocar em check");
		}
...
;			}
	...
	public ChessPiece replacePromotedPiece(String type) {
		if(promoted == null) {
			throw new IllegalAccessError("Nao ha peca para ser promovida");
		}
	...
	private void validateTargetPosition(Position source,Position target) {
		if (!board.piece(source).possibleMove(target)) throw new ChessException("A peca escolhida nao pode se mover para posicao de destino");
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalAccessError("Nao existe o rei " + color + " no tabuleiro");
	}
